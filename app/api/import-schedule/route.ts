...
export async function POST(req: Request) {
  try {
    ...
    } else if (headers.includes("theory") && headers.includes("practice") && headers.includes("credit")) {
        importType = "Subjects";
    ...
    } else if (headers.includes("teacher_id") && headers.includes("subject_id") && !headers.includes("role")) {
